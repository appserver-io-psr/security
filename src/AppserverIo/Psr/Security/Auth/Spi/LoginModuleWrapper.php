...
/**
 * AppserverIo\Psr\Security\Auth\Spi\LoginModuleWrapper
 *
 * NOTICE OF LICENSE
 *
 ...
 * @link      http://www.appserver.io
 */
class LoginModuleWrapper implements LoginModuleInterface
{

    /**
     * Inejcts the login module that has to be wrapped.
     *
     * @param \AppserverIo\Psr\Security\Auth\Spi\LoginModuleInterface $loginModule The login module to wrap
     *
     * @return void
     */
    public function injectLoginModule(LoginModuleInterface $loginModule)
    {
        $this->loginModule = $loginModule;
    }

    /**
     * Returns the login module instance that has to be wrapped.
     *
     * @return \AppserverIo\Psr\Security\Auth\Spi\LoginModuleInterface The wrapped instance
     */
    protected function getLoginModule()
    {
    ...
    {
        return $this->getLoginModule()->initialize($subject, $callbackHandler, $sharedState, $params);
    }
    ...
    {
        return $this->getLoginModule()->login();
    }
    ...
    {
        return $this->getLoginModule()->logout();
    }
    ...
    {
        return $this->getLoginModule()->abort();
    }
    ...
    {
        return $this->getLoginModule()->commit();
    }
}
