...
/**
 * AppserverIo\Psr\Security\Acl\GroupInterface
 *
 * NOTICE OF LICENSE
 *
...
namespace AppserverIo\Psr\Security\Acl;
...
interface GroupInterface
{
     ...
     *
     * @param \AppserverIo\Psr\Security\Auth\PrincipalInterface $pricipal The principal to add
     *
     ...
     *
     * @param \AppserverIo\Psr\Security\Auth\PrincipalInterface $principal The principal to remove
     *
     ...
     *
     * @param \AppserverIo\Psr\Security\Auth\PrincipalInterface $principal The principal to query membership for
     *
